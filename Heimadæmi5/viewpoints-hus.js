...
window.onload = function init() {
    ...
    window.addEventListener("keydown", function (e) {
        switch (e.keyCode) {
            case 48:    // 0: Liður a) Augað er ofan á húsinu sem er í hnitum (-40, 140) og horfir alltaf á bílinn. 
                view = 0;
            ...
            case 56:	// 8: from beside the car
                ...
                break;
            case 57:    // 9: Liður b) Augað er í fastri hæð (t.d. z = 5) og hægt er að hreyfa það áfram og afturábak
                view = 9;
                height=0.0;
                break;
...
function render() {
    ...
    switch (view) {
        case 0:
            // Liður a) Augað er ofan á húsinu sem er í hnitum (-40, 140) og horfir alltaf á bílinn. 
            mv = lookAt(vec3(-40.0, 140.0, 20 + height), vec3(carXPos, carYPos, 0.0), vec3(0.0, 0.0, 1.0));
            drawScenery(mv);
        ...
        case 8:
            ...
            break;
        case 9:
            // Liður b) Augað er í fastri hæð
            mv = lookAt(vec3(userXPos, 0.0 + userYPos, 10.0), vec3(userXPos + userXDir, 0.0 + userYPos + userYDir, 10.0), vec3(0.0, 0.0, 1.0));
            drawScenery(mv);
            mv = mult(mv, translate(carXPos, carYPos, 0.0));
            mv = mult(mv, rotateZ(carDirection));
            drawCar(mv);
