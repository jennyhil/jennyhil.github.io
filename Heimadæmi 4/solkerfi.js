...
var rotYear_moon = 0.0;
var tilt_moon = 0.0;

var rotYear_satelite = 0.0;
var tilt_satelite = 0.0;
...
function render() {
    ...
    rotYear_moon += 0.1 + speed;
    rotYear_satelite += 1 + speed;
    ...
    // Teikna tungl
    mv = mult(mv, rotateY(rotYear_moon));
    mv = mult(mv, translate(3, 0.0, 0.0));
    mv = mult(mv, rotateZ(tilt_moon));

    mv = mult(mv, scalem(0.8, 0.8, 0.8));
    gl.uniformMatrix4fv(matrixLoc, false, flatten(mv));
    gl.drawArrays(gl.TRIANGLES, 0, numVertices);

    // Teikna gervitungl 
    mv = mult(mv, rotateZ(rotYear_satelite));
    mv = mult(mv, translate(1.5, 0.0, 0.0));
    mv = mult(mv, rotateZ(tilt_satelite));
